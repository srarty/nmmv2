...
%
% Artemio - April 2021
function [x_hat, P_hat, K, fe, fi] = akf_iterate(x, P, Q, R, y, H, NStates,...
      NSamples, f_, scale_kf, scale_range,ALPHA_KF_LBOUND, ALPHA_KF_UBOUND, integration_method)

% Prediction step
%-------------- start prediction
if strcmpi('euler', integration_method)
    % Euler Integration
    [x_hat, P_hat, fe, fi] = f_(x, P); % [x_hat, P_hat] = f_(x, zeros(size(P0)));
    P_hat = P_hat + Q;
